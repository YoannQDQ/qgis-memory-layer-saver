...
from qgis.core import Qgis, QgsFeature, QgsField, QgsGeometry, QgsMapLayer, QgsProject
            ...
            if layers:
                try:
                    ...
                    QMessageBox.information(
                        self._iface.mainWindow(), "Error reloading memory layers", str(sys.exc_info()[1])
                    )
